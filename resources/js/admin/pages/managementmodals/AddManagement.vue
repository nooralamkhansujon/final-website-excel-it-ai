                    ...
                    <form>
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label class="form-label text-left" for="name"
                        ...
                        >
                            {{
                                isClicked ? "Please Wait..." : "Add Management"
                            }}
                        </button>
                    </form>
                </div>
...
export default {
    ...
    computed: {
        hideModal() {
            this.$emit("hideAddManagementModal");
        },
    },
    methods: {
        addDeveloper() {
            this.errors = {};
            this.isClicked = true;
            ManagementApi.store(this.setFormData())
                .then(({ data: { success } }) => {
                    this.isClicked = false;
                    this.resetForm();
                    Swal.fire("success", success, "success");
                    this.$emit("newManagementAdded");
                })
                .catch((error) => {
                    this.isClicked = false;
