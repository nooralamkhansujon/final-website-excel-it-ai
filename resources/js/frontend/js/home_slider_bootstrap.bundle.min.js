 ...
 */
export default function homeSliderBootstrap() {
    !(function (t, e) {
                ...
                return (
                    ...
                    (r._jQueryInterface = function (i) {
                        return this.each(function () {
                            ...
                            if (
                                (t ||
                                    ((t = new r(this, e)), p(this).data(x, t)),
                                "number" == typeof i)
                            )
                                t.to(i);
        ...
        var Ee = {
                ...
                modifiers: {
                    ...
                    preventOverflow: {
                        ...
                        fn: function (t, i) {
                            var e =
                                i.boundariesElement || jt(t.instance.popper);
                        ...
                        if (
                            ...
                            if ((c._clearMenus(), !e)) {
                                var n = { relatedTarget: this._element },
                                    i = p.Event(Ae.SHOW, n);
                                if (
                                    (p(t).trigger(i), !i.isDefaultPrevented())
                                ) {
                                    if (!this._inNavbar) {
        ...
        var Ge = "modal",
            ...
            gn = (function () {
                ...
                return (
                    ...
                    (t._getConfig = function (t) {
                        return (
                            (t = l({}, tn, t)), m.typeCheckConfig(Ge, t, en), t
                        );
                    }),
                    ...
                    (o._jQueryInterface = function (n, i) {
                        return this.each(function () {
                            ...
                            if (
                                (t ||
                                    ((t = new o(this, e)), p(this).data($e, t)),
                                "string" == typeof n)
                            ) {
                                if ("undefined" == typeof t[n])
                                    throw new TypeError(
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if (
                                ...
                                (t ||
                                    ((t = new i(this, e)), p(this).data(Cn, t)),
                                "string" == typeof n)
                            ) {
                                if ("undefined" == typeof t[n])
                                    throw new TypeError(
                    ...
                    (i._jQueryInterface = function (n) {
                        return this.each(function () {
                            ...
                            if (
                                (t || !/dispose|hide/.test(n)) &&
                                (t ||
                                    ((t = new i(this, e)), p(this).data(Qn, t)),
                                "string" == typeof n)
                            ) {
                                if ("undefined" == typeof t[n])
                                    throw new TypeError(
                ...
                return (
                    ...
                    (t._getConfig = function (t) {
                        if (
                            ...
                            e ||
                                ((e = m.getUID(oi)), p(t.target).attr("id", e)),
                                (t.target = "#" + e);
                        }
